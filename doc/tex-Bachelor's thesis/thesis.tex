...
\setdate{01}{01}{2001}
\settitle{Program understandig in Gforth/Forth}{Program understandig in Gforth/Forth} % sets English and German version of the title (both can be English or German)
\setsubtitle{A graphical approach}{A graphical approach} % sets English and German version of the subtitle (both can be English or German)
...
\input{chapters/summary_and_future_work.tex}
