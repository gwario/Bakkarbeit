...
Since Brainless only uses custom defining words and \emph{value}, the following graphic shows only values. But it should also take \emph{variable}, \emph{2variable}, \emph{fvariable}, ... into account.
